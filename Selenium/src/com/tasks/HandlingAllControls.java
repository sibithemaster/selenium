...
public class HandlingAllControls 
{
	...
	public void EdurekaProfile() throws InterruptedException
	{
		...
		driver.findElement(By.xpath("//li[@class='hidden-xs'][2]/child::span")).click();
		try {
			Thread.sleep(1000);
		} catch (InterruptedException e) {
			e.printStackTrace();
	...
	{
		HandlingAllControls h =new HandlingAllControls();
		h.EdurekaProfile();
	}
}